...
import './big-photo-card-info.scss';

import BigLikesCount from '../big-likes-count/big-likes-count';
import DateAdded from '../date-added/date-added';

const BigPhotoCardInfo = () => {
    return (
        <>
            <div className="big-photo-card__info big-photo-info">
                <a className="big-photo-info__author-link" href="#">OWEN Wen</a>
                <BigLikesCount/>
                <DateAdded/>
            </div>
        </>
...
export default BigPhotoCardInfo;
